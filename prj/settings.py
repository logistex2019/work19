...
STATIC_URL = '/static/'  # 앱 수준 정적 파일 폴더
STATICFILES_DIRS = [     # 프로젝트 수준 정적 파일 폴더
    os.path.join(BASE_DIR, 'prj', 'static'),  # 단일 항목이라도 마지막 쉼표를 써야 함!!!
]
# STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # 배포 시 필요한 설정
